module.exports = (function() {
    ...
    var _bind = function(ma, f) {
        ...
        return function(s) {
            ...
            var stateG = f(a); // chain the values from the state into the monadic function
            return stateG(newState); // chain prior state and the f-state to get the cumulative state of the two
        };
    };
